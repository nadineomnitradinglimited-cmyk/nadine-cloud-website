...
export default function Home() {
  return (
    <>
        ...
        <div className="wrap">
          ...
          <div className="offer-cards">
            <div className="offer-card">
              <div className="ic">
                <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#FBA30E" strokeWidth={2}>
      ...
      <section className="section cta-band" id="launch">
        <div className="wrap">
          <span className="eyebrow">All-in-one starter</span>
          <h2>Nadine Cloud — Launch</h2>
          <p>Everything to get your business online in one payment: a free domain, a year of hosting, and our drag-and-drop website builder — all for <b className="amt-live" data-zmw="850">ZMW 850</b>.</p>
      ...
      <section className="section" id="services">
        <div className="wrap">
          ...
          <div className="services-grid">
            <div className="svc">
              <div className="ic">
                <svg width={22} height={22} viewBox="0 0 24 24" fill="none" stroke="#FBA30E" strokeWidth={2}>
                  <rect x={3} y={4} width={18} height={14} rx={2} />
                  <path d="M3 9h18" />
                  <path d="m13.5 15.5 4-4 2 2-4 4h-2v-2Z" />
                </svg>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <div className="tech-row">
            <span className="tech-badge payment-badge" style={{ borderColor: "rgba(255,204,0,.4)" }}><img src="/assets/mtn-momo.png" alt="" width={20} height={20} style={{ borderRadius: 5 }} />MTN Mobile Money</span>
            <span className="tech-badge payment-badge" style={{ borderColor: "rgba(237,28,36,.4)" }}><img src="/assets/airtel-money.png" alt="" width={20} height={20} style={{ borderRadius: 5 }} />Airtel Money</span>
            <span className="tech-badge payment-badge" style={{ borderColor: "rgba(0,166,81,.4)" }}><img src="/assets/zamtel-money.png" alt="" width={20} height={20} style={{ borderRadius: "50%" }} />Zamtel Kwacha</span>
            ...
            <span className="tech-badge payment-badge" style={{ opacity: 0.6 }}><span style={{ fontFamily: "Georgia, serif", fontStyle: "italic", fontWeight: 800, color: "#4B57C4", fontSize: 15, letterSpacing: "-0.02em" }}>VISA</span> — coming soon</span>
          </div>
        </div>
      </section>
