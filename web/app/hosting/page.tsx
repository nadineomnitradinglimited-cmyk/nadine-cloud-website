        ...
        <div className="wrap">
          ...
          <div className="plans">
            <div className="plan">
              ...
              <div className="price"><span className="amt amt-live" data-zmw="99" data-intro-zmw="50">ZMW 50</span> <span className="per">/first month</span><small className="price-note" hidden></small></div>
      ...
      <section className="section cta-band">
        <div className="wrap">
          ...
          <div className="actions">
            ...
            <a className="btn-ghost" href="https://wa.me/260964068483?text=Hi%20Nadine%20Cloud%2C%20I%27d%20like%20to%20sign%20up%20for%20hosting." target="_blank" rel="noopener">Chat on WhatsApp</a>
          </div>
        </div>
      </section>
