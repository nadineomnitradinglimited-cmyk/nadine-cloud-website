      ...
      <section className="section" id="services">
        <div className="wrap">
          ...
          <div className="services-grid">
            <div className="svc">
              <div className="ic"><svg width={22} height={22} viewBox="0 0 24 24" fill="none" stroke="#1769FF" strokeWidth={2}><rect x={3} y={4} width={18} height={14} rx={2} /><path d="M3 9h18M8 21h8" /></svg></div>
            ...
            <div className="svc">
              <div className="ic"><svg width={22} height={22} viewBox="0 0 24 24" fill="none" stroke="#1769FF" strokeWidth={2}><path d="M12 3v18M3 12h18" /><circle cx={12} cy={12} r={9} /></svg></div>
            ...
            <div className="svc">
              <div className="ic"><svg width={22} height={22} viewBox="0 0 24 24" fill="none" stroke="#1769FF" strokeWidth={2}><rect x={3} y={3} width={7} height={7} rx={1} /><rect x={14} y={3} width={7} height={7} rx={1} /><rect x={3} y={14} width={7} height={7} rx={1} /><rect x={14} y={14} width={7} height={7} rx={1} /></svg></div>
            ...
            <div className="svc">
              <div className="ic"><svg width={22} height={22} viewBox="0 0 24 24" fill="none" stroke="#1769FF" strokeWidth={2}><path d="M3 12a9 9 0 1 0 9-9" /><path d="M3 12h6M3 12l3-3M3 12l3 3" /></svg></div>
